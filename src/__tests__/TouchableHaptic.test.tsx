...
describe("TouchableHaptic", () => {
  it("fires haptic on pressIn by default", () => {
    const el = TouchableHaptic({ hapticType: HapticFeedbackTypes.impactMedium }) as any;
  ...
  it("does not fire haptic on press when trigger is onPressIn", () => {
    const el = TouchableHaptic({ hapticType: HapticFeedbackTypes.impactMedium, hapticTrigger: "onPressIn" }) as any;
    el.props.onPress(mockEvent);
    expect(mockTrigger).not.toHaveBeenCalled();
  });

  it("fires haptic on press when hapticTrigger is onPress", () => {
    const el = TouchableHaptic({ hapticType: HapticFeedbackTypes.impactLight, hapticTrigger: "onPress" }) as any;
    el.props.onPress(mockEvent);
  ...
  it("fires haptic on longPress when hapticTrigger is onLongPress", () => {
    const el = TouchableHaptic({ hapticType: HapticFeedbackTypes.impactHeavy, hapticTrigger: "onLongPress" }) as any;
  ...
  it("still calls the original onPressIn handler", () => {
    ...
    const el = TouchableHaptic({ onPressIn }) as any;
    el.props.onPressIn(mockEvent);
  ...
  it("still calls the original onPress handler", () => {
    ...
    const el = TouchableHaptic({ hapticTrigger: "onPress", onPress }) as any;
    el.props.onPress(mockEvent);
  ...
  it("still calls the original onLongPress handler", () => {
    ...
    const el = TouchableHaptic({ hapticTrigger: "onLongPress", onLongPress }) as any;
    el.props.onLongPress(mockEvent);
