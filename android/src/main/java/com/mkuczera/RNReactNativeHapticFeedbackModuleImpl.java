...
public class RNReactNativeHapticFeedbackModuleImpl {
  ...
  public static void trigger(ReactApplicationContext reactContext, String type, ReadableMap options) {
    // Check system settings, if disabled and we're not explicitly ignoring then
    // return immediatly
    ...
    if (ignoreAndroidSystemSettings == false && !isVibrationEnabled)
      return;
    ...
    if (v == null || targetVibration == null)
      return;
